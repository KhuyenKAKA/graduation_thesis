...
--
-- Table structure for table `chat_session_summaries`
--
...
CREATE TABLE `chat_session_summaries` (
  ...
  CONSTRAINT `chat_session_summaries_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `chat_sessions` (`id`) ON DELETE CASCADE
